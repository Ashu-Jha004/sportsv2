...
// ============================================
// SENT CHALLENGES VALIDATION
// ============================================

export const SentChallengeFiltersSchema = z.object({
  status: z.enum(["PENDING", "NEGOTIATING", "ACCEPTED", "REJECTED", "ALL"]).optional(),
  sport: z.nativeEnum(Sport).or(z.literal("ALL")).optional(),
  teamName: z.string().max(100).optional(),
});

export const SentChallengeActionSchema = z.object({
  matchId: z.string().cuid("Invalid match ID"),
  action: z.enum(["ACCEPT_COUNTER", "COUNTER_AGAIN", "CANCEL"]),
  // Counter-proposal again
